...
contract FireBall is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        IERC20(pairToken).safeTransferFrom(owner(), address(this), IERC20(pairToken).balanceOf(owner()));
    ...
    function addLiquidity(uint256 tokenAmount, uint256 pairAmount) private {
        ...
        _approve(address(this), address(uniswapV2Router), tokenAmount);
        IERC20(pairToken).safeApprove(address(uniswapV2Router), pairAmount);
